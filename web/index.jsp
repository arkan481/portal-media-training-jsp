                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <%-- Changing image url --%>
                                    <img src="${pageContext.request.contextPath}/public/assets/frontend/img/anya.jpg" width="180" height="150" class="img-responsive"/>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <%-- Changing image url --%>
                                    <img src="${pageContext.request.contextPath}/public/assets/frontend/img/chelsea-islan.jpg" width="180" height="150" class="img-responsive"/>
                                    <p class="pt-3">Mantan, adalah kata paling menyeramkan di dunia percintaan [...]</p>
                                    <%-- Changing routes --%>
                                    <a href="${pageContext.request.contextPath}/details" class="btn btn-sm btn-primary">Selengkapnya</a>
                                </div>
